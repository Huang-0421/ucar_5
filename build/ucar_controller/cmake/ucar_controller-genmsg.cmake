...
get_filename_component(_filename "/home/ucar/ucar_5/src/ucar_controller/srv/SetMaxVel.srv" NAME_WE)
add_custom_target(_ucar_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ucar_controller" "/home/ucar/ucar_5/src/ucar_controller/srv/SetMaxVel.srv" ""
)

get_filename_component(_filename "/home/ucar/ucar_5/src/ucar_controller/srv/SetSensorTF.srv" NAME_WE)
add_custom_target(_ucar_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ucar_controller" "/home/ucar/ucar_5/src/ucar_controller/srv/SetSensorTF.srv" ""
)

get_filename_component(_filename "/home/ucar/ucar_5/src/ucar_controller/srv/GetMaxVel.srv" NAME_WE)
add_custom_target(_ucar_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ucar_controller" "/home/ucar/ucar_5/src/ucar_controller/srv/GetMaxVel.srv" ""
)

get_filename_component(_filename "/home/ucar/ucar_5/src/ucar_controller/srv/GetSensorTF.srv" NAME_WE)
add_custom_target(_ucar_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ucar_controller" "/home/ucar/ucar_5/src/ucar_controller/srv/GetSensorTF.srv" ""
)

get_filename_component(_filename "/home/ucar/ucar_5/src/ucar_controller/srv/SetLEDMode.srv" NAME_WE)
add_custom_target(_ucar_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ucar_controller" "/home/ucar/ucar_5/src/ucar_controller/srv/SetLEDMode.srv" ""
)

get_filename_component(_filename "/home/ucar/ucar_5/src/ucar_controller/srv/GetBatteryInfo.srv" NAME_WE)
add_custom_target(_ucar_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ucar_controller" "/home/ucar/ucar_5/src/ucar_controller/srv/GetBatteryInfo.srv" "sensor_msgs/BatteryState:std_msgs/Header"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ucar_controller)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ucar_controller\")")
  # install generated code
  install(
