...
echo_and_run cd "/home/ucar/ucar_5/src/geometry/tf_conversions"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ucar/ucar_5/src/geometry/tf_conversions/setup.py" \
     \
    build --build-base "/home/ucar/ucar_5/build/geometry/tf_conversions" \
    install \
    --root="${DESTDIR-/}" \
