...
(defsystem "darknet_ros_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "classes" :depends-on ("_package_classes"))
    (:file "_package_classes" :depends-on ("_package"))
    (:file "classes(¿Y⌐╚¿aí÷)" :depends-on ("_package_classes(¿Y⌐╚¿aí÷)"))
    (:file "_package_classes(¿Y⌐╚¿aí÷)" :depends-on ("_package"))
    (:file "classes_b" :depends-on ("_package_classes_b"))
    (:file "_package_classes_b" :depends-on ("_package"))
  ))